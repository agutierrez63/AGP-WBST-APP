    ...
    <div className='text-black'>
      <div className='max-w[800px] mt-[-96px] w-full h-screen mx-auto text-center flex flex-col justify-center'>
        ...
        <div className='flex justify-center items-center '>
          <p className='md:text-5xl sm:text-4xl text-xl font-bold py-4'>business cards, banners, and </p>
          <Typed className='md:text-5xl sm:text-4xl text-xl font-bold md:pl-4 pl-2' strings={['decals', 'graphics', 't-shirts']} typeSpeed={180} backSpeed={200} loop/>
        </div>
