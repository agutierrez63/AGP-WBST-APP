  ...
  return (
    ...
    <div className='text-black'>
      <div className='max-w[800px] mt-[-96px] w-full h-[200px] mx-auto text-center flex flex-col justify-center'>
        <h1 className='md:text-5xl sm:text-4xl text-2xl font-bold md:py-6'>Contact Us</h1>
      </div>
    </div>
    ...
    <div className='w-full bg-white py-16 text-white px-4'>
      <div className='max-w-[1240px] mx-auto grid lg:grid-cols-3'>
        ...
        <div className='lg:col-span-2 my-4'>
          ...
          <img className='w-[350px] mx-auto my-4 justify object-left' src={CompanyLogo} alt='/'/>
        </div>
